  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <h1>
          BIENVENIDO AL REPORTE DE MICRORED PAP POR RESULTADO <img width="40" height="40" src="public/foto/office_excel.png">
          <small></small>
        </h1>
        <ol class="breadcrumb">
              ...
              <div class="box-body">
                <div class="tab-content">
                  <div class="tab-pane active" id="tab_1">
                    <?php echo form_open_multipart('Reportes_papmcr_c/exportar_mes'); ?>
                    <div class="col-md-4">
                    <div class="box-body">
                ...
                <div class="tab-pane" id="tab_2">
                  <?php echo form_open_multipart('Reportes_papmcr_c/exportar_annio'); ?> 
                  <div class="col-md-4">
                    <div class="box-body">
                      <div class="form-group">
                        <label>Red</label>
                ...
                <div class="tab-pane" id="tab_3">
                  <?php echo form_open_multipart('Reportes_papmcr_c/rango_mes'); ?>
                  <div class="col-md-5">
                    <div class="box-body">
                      <div class="form-group">
                        <label>Red</label>
...
$('#reservation').daterangepicker();
  ...
  function rango_mes(){
   ...
   if (id!='0') {
    ...
    $.post("<?php echo base_url();?>Reportes_papmcr_c/validar_mes",{"id":id,"id_mes":id_mes},
      function(data){
...
function rango_annio(){
 ...
 if(id!='-1'){
  ...
  $.post("<?php echo base_url();?>Reportes_papmcr_c/validar_annio",{"id":id},    function(data){
    var obj =JSON.parse(data);
    var nombre;
