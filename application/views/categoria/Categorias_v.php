  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        ...
        <small><button type="button" id="agregar" class="btn btn-block btn-primary"><i class="fa fa-th-list"></i><i class="fa   fa-plus"></i></button></small>
      </h1>
      <ol class="breadcrumb">
                ...
                <tr id="<?php echo $value->id_categorias; ?>">
                  ...
                  <td ><div class="btn-group">
                      <a class="btn btn-info" href="<?php echo base_url().'Categorias_c/editar/'.$value->id_categorias;?>" ><i class="fa fa-pencil"></i></a> 
                       <a class="btn btn-danger" onclick="mostrar_eliminar(<?php echo $value->id_categorias; ?>)" data-toggle="modal" data-target="#eliminar_modal"><i class="fa  fa-th-list"></i><i class="fa  fa-times"></i></a>
                    </div></td>
                </tr>
                <?php  } ?>
                </tbody>
