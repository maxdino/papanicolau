            ...
            <form class="form-horizontal" id="editar_formulario" name="editar_formulario">
              <div class="box-body">
                <div class="form-group">
                  <label for="clave" class="col-sm-2 control-label">Nuevo Usuario</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" autocomplete="off" id="usuario" name="usuario" placeholder="NUEVO USUARIO">
                  </div>
                </div>
              <!-- /.box-body -->
              <div class="box-footer">
                <a type="submit" href="<?php echo base_url();?>Perfil_c" class="btn btn-danger"><i class="fa fa-sign-out"></i> Cancelar</a>
                <button type="submit" class="btn btn-info pull-right"><i class="fa fa-upload"></i> Modificar Usuario</button>
              </div>
              <!-- /.box-footer -->
            </form>
          </div>
...
<script>
  ...
  $('#editar_formulario').on("submit", function(e){
    ...
    if (usuario!='') {
      ...
      var url = "<?php echo base_url();?>Perfil_c/modificar_usuario";
      $.ajax({                        
       type: "POST",                 
       url: url,                     
       data: formData,
