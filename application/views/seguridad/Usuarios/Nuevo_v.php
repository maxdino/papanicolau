            ...
            <form class="form-horizontal">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="apellidos" style="text-transform: uppercase;" placeholder="Apellidos">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="password" class="form-control" id="clave_con" placeholder="CONFIRMAR CONTRASEÑA">
 ...
 <script>
  ...
  $( "#agregar" ).click(function() {
    ...
    if (nombres!=''&&apellidos!=''&&usuario!=''&&clave!=''&&clave_con!='') {
      if (clave==clave_con) {
   $.post("<?php echo base_url();?>Usuarios_c/agregar",{"nombres":nombres,"clave":clave,"apellidos":apellidos,"usuario":usuario},
        function(data){
