            ...
            <form class="form-horizontal">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="apellidos" autocomplete="off" style="text-transform: uppercase;" placeholder="Apellidos">
                  </div>
                </div>
                <div class="form-group">
                  <label for="usuario" class="col-sm-2 control-label">Usuario</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="usuario" autocomplete="off" placeholder="USUARIO">
                  </div>
                </div>
                <div class="form-group">
                  <label for="clave" class="col-sm-2 control-label">Contraseña</label>
                  <div class="col-sm-10">
                    <input type="password" class="form-control" autocomplete="off" id="clave" placeholder="CONTRASEÑA">
                  </div>
                </div>
                <div class="form-group">
                  <label for="clave_con" class="col-sm-2 control-label">Confirmar Contraseña</label>
                  <div class="col-sm-10">
                    <input type="password" class="form-control" autocomplete="off" id="clave_con" placeholder="CONFIRMAR CONTRASEÑA">
                  </div>
                </div>
                <div class="form-group">
...
<script>
  ...
  $( "#agregar" ).click(function() {
    ...
    if (nombres!=''&&apellidos!=''&&usuario!=''&&clave!=''&&clave_con!=''&&perfil_usuario!='0') {
      if (clave==clave_con) {
       $.post("<?php echo base_url();?>Usuarios_c/agregar",{"nombres":nombres,"clave":clave,"apellidos":apellidos,"usuario":usuario,"perfil_usuario":perfil_usuario},
        function(data){
          swal({
