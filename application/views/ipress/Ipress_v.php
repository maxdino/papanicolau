  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        ...
        <small><button type="button" id="agregar" class="btn btn-block btn-primary"><i class="fa fa-hospital-o"></i></button></small>
      </h1>
      <ol class="breadcrumb">
                ...
                <tr id="<?php echo $value->codigo; ?>">
                  ...
                  <td ><div class="btn-group">
                      <a class="btn btn-info" href="<?php echo base_url().'Ipress_c/editar/'.$value->codigo;?>" ><i class="fa fa-pencil"></i></a> 
                       <a class="btn btn-danger" onclick="mostrar_eliminar(<?php echo $value->codigo; ?>)" data-toggle="modal" data-target="#eliminar_modal"><i class="fa fa-trash"></i></a>
                    </div></td>
                </tr>
                <?php  $i++; } ?>
                </tbody>
